const CACHE_NAME="cablemaster-configurator-v6";
const ASSETS=["./","./index.html","./styles.css","./app.js","./sw.js","./manifest.webmanifest","./data/catalog.json","./data/engine.json","./assets/icon-192.png","./assets/icon-512.png"];
